...
/*
  ...
  with our heavily-modified Type-A Machines printer.
  We've added a clone ReprapDiscount 4x20 LCD, an E3D clone hotend
  and inductive probe (with aluminum bed).

  Our Type-A started life as a stock "Type A Machines Series I" -
  the lasercut plywood version.  It's a fairly conventional cartesian layout,
  with moving XY gantry and dropping bed.  It uses RAMPS electronics.

  One unusual feature is that the gantry is driven in the Y direction by two
...
#ifndef MOTHERBOARD
  // for the AMT printer, we choose this even though we have no heated bed.
...
#define CUSTOM_MACHINE_NAME "AMT-Modified Type-A"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // from autotune with earlier Marlin.
 ...
 */
// these values from original Type-A config.  They do not appear to be for a 2mm belt;
// Perhaps they're T2.5? ...anyway they work.
//
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 150.15/2, 150.15, 3200/4, 202 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
// as configured in original Type-A firmware:
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 15, 45 }
